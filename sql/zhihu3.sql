...
-- Records of answer
-- ----------------------------
INSERT INTO `answer` VALUES (1, '很有力balabala', NULL, 1, 1, 256, 20, NULL);
INSERT INTO `answer` VALUES (2, '很无力balabalaaaaa', NULL, 1, 1, 130, 11, NULL);
INSERT INTO `answer` VALUES (3, '很无力balabala', NULL, 3, 2, 112, 35, NULL);
INSERT INTO `answer` VALUES (4, 'qw', NULL, 1, 2, 4000, 76, NULL);
INSERT INTO `answer` VALUES (5, '我认为人工智能在最近几年突然成井喷式发展最重要的推动力就是Nvidia黄夹克家的CUDA之GPU将算力直接以几何级数的级别提升了，使能够真正在算力的加持下验证>改进>验证实现了螺旋上升...', NULL, 2, 2, 2333, 118, NULL);
INSERT INTO `answer` VALUES (6, '没有问题', NULL, 3, 3, 5454, 1233, NULL);
